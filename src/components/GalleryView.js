...
function ImageGallery() {
  ...
  useEffect(()=>{
    ...
    const imageCards = GalleryView?GalleryView.map((data,i) => (
      <img className="image-card col-lg-3 col-md-3 col-sm-6 col-6 mb-4" data-aos="zoom-in" data-aos-duration={1000*(i+1)} key={i} onClick={() => showImage(i)} src={`https://teamwebdevelopers.com/charge_construct/public/images/gallery/${data.image}`} />
    )):'';
      ...
      <>
        <div className="row position-relative">
          ...
          <div id="lightbox" onClick={hideLightBox}>
            ...
            <img id="lightbox-img" src={`https://teamwebdevelopers.com/charge_construct/public/images/gallery/${imageToShow}`} className="img-fluid"/>
