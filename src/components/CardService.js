        ...
        <div className='card-service' data-aos="fade-up" data-aos-duration={1000*(index+1)}>
          <div className="flip-card">
            <div className="flip-card-inner">
              ...
              {item.src_img?<img src={item.src_img?`assets/images/service/${item.src_img}`:''}/>:''}
...
Charge Construct vermittelt Ihnen das Einmaleins der Elektromobilität und berät Sie als unabhängiger Partner in der frühen Phase des Vorhabens, um von Anfang an alles richtig zu machen. Auf Basis einer Standortbegehung (auf Wunsch auch digital) werden unter Berücksichtigung der jeweiligen Anforderungen an das...</p>
   <Button title="lorem ipsum" link="#" classs='cc-transbutton text-decoration-none'/>
                ...
                {/* <div className='flip-card-content flip-card-back'>
                <a href={item.ser_btn_txt}>{item.ser_btn_label}</a>
                  <h3>{item.src_title}</h3>
                  <p>{item.src_des}</p>
                </div> */}
              ...
              {/* <div className="flip-card-back">
                <h3>Befähigung & Konzeptberatung</h3>
                <p>Sie möchten Ladeinfrastruktur errichten, sind jedoch mit dieser Thematik grundsätzlich überfordert?

                  Charge Construct vermittelt Ihnen das Einmaleins der Elektromobilität und berät Sie als unabhängiger Partner in der frühen Phase des Vorhabens, um von Anfang an alles richtig zu machen. Auf Basis einer Standortbegehung (auf Wunsch auch digital) werden unter Berücksichtigung der jeweiligen Anforderungen an das Laden inklusive Abrechnung und Begebenheiten vor Ort passende Möglichkeiten für die Umsetzung aufgezeigt. Charge Construct liefert Ihnen neben einer ausführlichen Dokumentation auch eine passende Konzeptplanung sowie eine Grobkostenschätzung. So haben Sie alles in der Hand, um am Ende die richtige Entscheidung zu treffen und alle Potenziale zu nutzen.

                  Gerne erbringen wir für eine bessere Planungssicherheit diesen Service zum Festpreis!
                  Fragen Sie hier einen Termin für die Standortbegehung an.</p>
