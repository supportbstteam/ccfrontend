...
function CategoryContent(props) {
    ...
    var mainslug = useRouter();
    const slugpost = mainslug.query.slug;
    ...
    return (
     ...
     data-aos-duration="1000">
                    <h1 className='section-title text-dark mb-5 text-capitalize'>{slugpost}</h1>
...
export async function getServerSideProps(context) {
    ...
    //const postID = router.query.id;
      ...
      const response = await fetch(`https://teamwebdevelopers.com/charge_construct/api/blogPost/${slug}`);
